  ...
  <div class="container">
    ...
    <div class="mt-8 flex items-start">
      <div class="sticky top-8 hidden w-60 lg:block">
        <div class="flex w-full" v-if="store.adminModel">
          <ui-button
        ...
        <ui-list class="space-y-2">
          <ui-list-item>
            ...
            <span class="ml-4 capitalize cursor-pointer"  @click="openOnlineDialog">
              {{ t('workflow.browse') }}
            </span>
          </ui-list-item>
          <ui-expand
...
async function openOnlineDialog() {
  try {
    emitter.emit('ui:online', { show: true })
  } catch (error) {
    console.error(error);
  }
}
