...
const options = {
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({
      ...
      HZERO_PATH: JSON.stringify(process.env.HZERO_PATH || 'HZERO_PATH'),
      HZERO_AUTOMA_CLIEN_ID: JSON.stringify(process.env.HZERO_AUTOMA_CLIEN_ID || 'HZERO_AUTOMA_CLIEN_ID'),
      HZERO_AUTOMA_CLIEN_KEY: JSON.stringify(process.env.HZERO_AUTOMA_CLIEN_KEY || 'HZERO_AUTOMA_CLIEN_KEY'),
      HZERO_INTERFACE_CODE: JSON.stringify(process.env.HZERO_INTERFACE_CODE || 'HZERO_INTERFACE_CODE'),
      HZERO_INTERFACE_LIST: JSON.stringify(process.env.HZERO_INTERFACE_LIST || 'HZERO_INTERFACE_LIST'),
      HZERO_INTERFACE_CONFIG: JSON.stringify(process.env.HZERO_INTERFACE_CONFIG || 'HZERO_INTERFACE_CONFIG'),
    }),
